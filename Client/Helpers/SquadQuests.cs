...
{
    // Based on AllQuestsCheckmarks by ZGFueDkx (GPL-3.0) - Fika squad member quest tracking
    internal static class SquadQuests
    {
        ...
        public static void LoadData(Dictionary<string, string> squadMembers)
        {
            ...
            string response = RequestHandler.PostJson("/item-purpose-checkmarks/active-quests", new JArray(squadMembers.Keys).ToJson());
